...
```{r, fig.cap = "**Figure 1:** The top five words that appear in the Gospel of Matthew and in First Corinthians. Words like 'the' and 'are' have been removed from the analysis. Since this is from the New King James Version, other words like 'thou', 'thee', 'ye', 'thy', 'hath', 'yea', 'saith', 'hast', 'shalt'."}
# compound graph
...
```{r, fig.cap = "**Figure 2:** A word cloud of the top 100 words from the Gospel of Matthew, New King James Version."}
# word cloud
...
```{r, fig.cap = "**Figure 3:** A word cloud of the top 100 words from First Corinthians, New King James Version."}
...
## AFINN Analysis
```{r, fig.cap = "**Figure 4:** Affin sentiment analysis, where positive numbers show positive sentiment and negative numbers indicate negative sentiment. The words 'cock' (rooster) and 'ass' (donkey) have been removed because their meaning is misconstrued by the sentiment analysis."}
